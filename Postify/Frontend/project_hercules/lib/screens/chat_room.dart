...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<Message> createMessage(String fromId , String toId, String body , String date, String time,int timeStamp) async {
    final http.Response response = await http.post(
      Uri.parse("http://192.168.29.199:5000/chatInfo/uploadMessage"),
...
Future<List<Message>> searchMessage(String fromId , String toId) async {
    ...
    final response = await http.get(Uri.parse("http://192.168.29.199:5000/chatInfo/search/"+fromId+"/"+toId)) ;
  ...
  for(var eachMessage in responseData) {
    ...
    final response2 = await http.get(Uri.parse("http://192.168.29.199:5000/chatInfo/search/"+toId+"/"+fromId)) ;
